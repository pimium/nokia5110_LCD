...
*       Filename:  PCD8544.h
*
*    Description:  Driver file for the PCD8544 display device
*
*        Version:  1.0
*        Created:  22 April 2017 11:32
*
...
#define SDnC_pin 10
#define SCEN_pin 11
#define SRES (1 << SRES_pin)
#define SCLK (1 << SCLK_pin)
#define SDIN (1 << SDIN_pin)
#define SDnC (1 << SDnC_pin)
#define SCEN (1 << SCEN_pin)
...
void clear_NOKIA_CLK(void);
void set_NOKIA_DIN(void);
void clear_NOKIA_DIN(void);
void set_NOKIA_DnC(void);
