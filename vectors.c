...
// Reserved 0x08
void __Reserved_0x08_Handler(void)
...
// Reserved 0x98
void __Reserved_0x98_Handler(void)
    __attribute__((interrupt, weak, alias("__Default_Handler")));

// Reserved 0x9C
void __Reserved_0x9C_Handler(void)
    __attribute__((interrupt, weak, alias("__Default_Handler")));
...
// Reserved 0xAC
void __Reserved_0xAC_Handler(void)
    __attribute__((interrupt, weak, alias("__Default_Handler")));
